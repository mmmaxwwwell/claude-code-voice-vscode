...
- [x] REVIEW Code review: check all implementation against spec FRs, constitution principles, research.md decisions. Auto-fix issues found. Write `REVIEW-TODO.md` for anything requiring human judgment.
